...
function fetchProductsByCategory(category) {
    fetch(`https://fakestoreapi.com/products/category/${category}`)  // Corrected with backticks
        .then(res => res.json())
        .then(products => {
...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        productPrice.textContent = `$${product.price}`;  // Corrected with backticks and dollar sign inside string
...
function addToCart(product) {
    ...
    cartPrice.textContent = `$${product.price}`;  // Corrected with backticks and dollar sign inside string
